...
LostItemsPack:AddCallback(ModCallbacks.MC_ENTITY_TAKE_DMG, ArmorDamage)
...
LostItemsPack:AddCallback(ModCallbacks.MC_POST_NPC_RENDER, BallsOfSteelArmorIndicator)
