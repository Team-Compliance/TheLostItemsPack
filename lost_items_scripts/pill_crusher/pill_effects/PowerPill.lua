...
LostItemsPack:AddCallback(ModCallbacks.MC_ENTITY_TAKE_DMG, DoublePlayerDamage, EntityType.ENTITY_PLAYER)
...
LostItemsPack:AddCallback(ModCallbacks.MC_POST_PEFFECT_UPDATE, PlayerUpdate)
