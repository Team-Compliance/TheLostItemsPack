...
LostItemsPack:AddCallback(ModCallbacks.MC_POST_FIRE_TEAR, LuckySevenTears.OnTearInit)
...
LostItemsPack:AddCallback(ModCallbacks.MC_PRE_TEAR_COLLISION, LuckySevenTears.OnTearCollision)