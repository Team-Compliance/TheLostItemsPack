...
LostItemsPack:AddCallback(ModCallbacks.MC_POST_LASER_INIT, LuckySevenLasers.OnLaserInit)
...
LostItemsPack:AddCallback(ModCallbacks.MC_POST_LASER_RENDER, LuckySevenLasers.OnLaserRender)
...
function LuckySevenLasers:OnEntityDamage(entity, _, flags, source)
    ...
    if not player:HasCollectible(LostItemsPack.CollectibleType.LUCKY_SEVEN) or
...
LostItemsPack:AddCallback(ModCallbacks.MC_ENTITY_TAKE_DMG, LuckySevenLasers.OnEntityDamage)