...
LostItemsPack:AddCallback(ModCallbacks.MC_NPC_UPDATE, DonationMachine.OnCoinUpdate, EntityType.ENTITY_ULTRA_COIN)
...
LostItemsPack:AddCallback(ModCallbacks.MC_ENTITY_TAKE_DMG, DonationMachine.OnCoinDamage, EntityType.ENTITY_ULTRA_COIN)
