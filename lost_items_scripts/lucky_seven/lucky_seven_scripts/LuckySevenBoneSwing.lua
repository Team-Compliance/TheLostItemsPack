...
LostItemsPack:AddCallback(ModCallbacks.MC_POST_KNIFE_RENDER, LuckySevenBoneSwing.OnKnifeRender)


function LuckySevenBoneSwing:OnNewRoom()
    KnifeAnimations = {}
end
LostItemsPack:AddCallback(ModCallbacks.MC_POST_NEW_ROOM, LuckySevenBoneSwing.OnNewRoom)